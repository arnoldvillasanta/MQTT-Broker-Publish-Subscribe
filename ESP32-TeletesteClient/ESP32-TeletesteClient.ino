...
EspMQTTClient client(
  ...
  "TelesteClient4"        // Client name that uniquely identify your device
);
...
//=======================================================================
//                    FUNCTION:  Get Data  (16 Bytes/Characters)
//=======================================================================

String getSensorData() {
  messageCounter++;
  return "Message " + String(messageCounter) + " from Teleste Client.";
...
void onConnectionEstablished()
{
  ...
  client.publish("messageData/", "TelesteClient started", true); // You can activate the retain flag by setting the third parameter to true
